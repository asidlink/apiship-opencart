			...
			createPlacemarks: (points, map) => {
				...
				for (const point of points) {
					...
					const balloonContentBody =						
						...
						(point.paymentCash == 1 ? '<img title="Оплата наличными" src="./extension/apiship/catalog/view/theme/default/image/shipping/apiship_cash.png">' : '') + ' ' +
						(point.paymentCard == 1 ? '<img title="Оплата картой" src="./extension/apiship/catalog/view/theme/default/image/shipping/apiship_card.png">' : '');
